...
@Component({
    ...
    imports: [BannerComponent, PartnersComponent, PaymentExperiencesComponent, TrustedWorldComponent, GetStartedComponent, AboutComponent, GrowYourBusinessComponent],
